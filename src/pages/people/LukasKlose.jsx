...
export default function LukasKlose() {
  ...
  // reference to publications from firebase databse
  const [publicationList, setPublicationList] = useState([]);
  const publicationCollectionRef = collection(db, "Publications/Lukas Klose/Lukas Klose Publications");

  // reference to image from firebase storage
  const [imageURL, setImageURL] = useState(null);
  const storageRef = ref(storage, "Profile Images/Lukas Klose");
